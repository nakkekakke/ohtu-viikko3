...
public class Stepdefs {
    ...
    @When("^a valid username \"([^\"]*)\" and password \"([^\"]*)\" and a wrong password confirmation \"([^\"]*)\" are entered$")
    public void a_valid_username_and_password_and_a_wrong_password_confirmation_are_entered(String username, String password, String passwordConfirmation) throws Throwable {
    ...
    @Then("^user is not logged in and error \"([^\"]*)\" is reported$")
    public void user_is_not_logged_in_and_error_is_reported(String errorMessage) throws Throwable {
